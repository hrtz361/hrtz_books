...
void BorrowTicket::inputData() {
    ...
    cout << "Ngày Thực Trả (DD/MM/YYYY): "; cin >> rDate;
...
void displayMenu() {
    ...
    cout << left 
         ...
         << setw(w) << "3. Sua Thong Tin Sach"   << setw(w) << "9. Gia Han The Doc"      << setw(w) << "15. Tim DS No Sach" << endl
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 10: { int l; cout << "Nhap so dòng nguoi doc can chan: "; cin >> l; blockReader(l); pauseExecution(); break; }
